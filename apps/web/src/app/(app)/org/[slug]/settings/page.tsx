...
export default async function Settings() {
    ...
    return(
        <div className="space-y-4">
            ...
            <div className="space-y-4">
                {canUpdatOrganization && (
                   <Card>
                    <CardHeader>
                        <CardTitle>Organization Settings</CardTitle>
                        <CardDescription>Update yout organization details</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <OrganizationForm 
                            isUpdating
                ...
                {canShutdownOrganization && (
                   <Card>
                    <CardHeader>
                        <CardTitle>Shutsown Organization</CardTitle>
                    ...
                    <CardContent><ShutdownOrganizationButton/></CardContent>
                   </Card> 
                )}
            </div>
        </div>
